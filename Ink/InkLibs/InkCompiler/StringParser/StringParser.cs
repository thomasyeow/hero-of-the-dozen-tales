...
namespace Ink
{
    public class StringParser
    {
        ...
        public StringParser(string str)
        {
            ...
            _chars = str != null ? str.ToCharArray() : (new char[0]);
        ...
        public char currentCharacter
        {
            get
            {
                return index >= 0 && remainingLength > 0 ? _chars[index] : (char)0;
            }
        }
        ...
        protected object Expect(ParseRule rule, string message = null, ParseRule recoveryRule = null)
        {
            ...
            if (result == null)
            {
                ...
                butSaw = lineRemainder == null || lineRemainder.Length == 0 ? "end of line" : "'" + lineRemainder + "'";
        ...
        public ParseRule Exclude(ParseRule rule)
        {
            ...
            {
                object result = ParseObject(rule);
                return result == null ? null : (object)ParseSuccess;
            };
        }
        ...
        public List<T> Interleave<T>(ParseRule ruleA, ParseRule ruleB, ParseRule untilTerminator = null, bool flatten = true)
        {
            ...
            return results.Count == 0 ? (List<T>)FailRule(ruleId) : (List<T>)SucceedRule(ruleId, results);
        }
        ...
        public string ParseString(string str)
        {
            ...
            return success ? (string)SucceedRule(ruleId, str) : (string)FailRule(ruleId);
        }
        ...
        public string ParseCharactersFromCharSet(CharacterSet charSet, bool shouldIncludeChars = true, int maxCount = -1)
        {
            ...
            return lastCharIndex > startIndex ? new string(_chars, startIndex, index - startIndex) : null;
        }
        ...
        public string ParseUntil(ParseRule stopRule, CharacterSet pauseCharacters = null, CharacterSet endCharacters = null)
        {
            ...
            return parsedString.Length > 0 ? (string)SucceedRule(ruleId, parsedString.ToString()) : (string)FailRule(ruleId);
        ...
        protected string ParseNewline()
        {
            ...
            return ParseString("\n") == null ? (string)FailRule(ruleId) : (string)SucceedRule(ruleId, "\n");
        }
