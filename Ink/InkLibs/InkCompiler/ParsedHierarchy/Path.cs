...
namespace Ink.Parsed
{
    public class Path
    {
        public FlowLevel baseTargetLevel
        {
            get
            {
                return baseLevelIsAmbiguous ? FlowLevel.Story : (FlowLevel)_baseTargetLevel;
            }
        }
        ...
        public string firstComponent
        {
            get
            {
                return components == null || components.Count == 0 ? null : components[0].name;
            }
        }
        ...
        public override string ToString()
        {
            return components == null || components.Count == 0
                ? baseTargetLevel == FlowLevel.WeavePoint ? "-> <next gather point>" : "<invalid Path>"
        ...
        public Parsed.Object ResolveFromContext(Parsed.Object context)
        {
            ...
            //  e.g. ==> base.mid.FINAL
            return components.Count > 1 ? ResolveTailComponents(baseTargetObject) : baseTargetObject;
        }
        ...
        Parsed.Object ResolveTailComponents(Parsed.Object rootTarget)
        {
            ...
            for (int i = 1; i < components.Count; ++i)
            {
                ...
                minimumExpectedLevel = foundFlow != null ? foundFlow.flowLevel + 1 : FlowLevel.WeavePoint;
