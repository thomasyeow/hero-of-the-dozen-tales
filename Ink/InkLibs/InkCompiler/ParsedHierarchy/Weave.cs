...
namespace Ink.Parsed
{
    ...
    public class Weave : Parsed.Object
    {
        ...
        {
            baseIndentIndex = indentIndex == -1 ? DetermineBaseIndentationFromContent(cont) : indentIndex;
        ...
        public IWeavePoint WeavePointNamed(string name)
        {
            ...
            return _namedWeavePoints.TryGetValue(name, out weavePointResult) ? weavePointResult : null;
        }
