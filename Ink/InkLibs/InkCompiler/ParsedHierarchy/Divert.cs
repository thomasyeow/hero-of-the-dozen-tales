    ...
    public class Divert : Parsed.Object
    {
        ...
        void CheckArgumentValidity()
        {
            ...
            if (paramCount != numArgs)
            {
                ...
                string butClause = numArgs == 0 ? "but there weren't any passed to it" : numArgs < paramCount ? "but only got " + numArgs : "but got " + numArgs;
        ...
        {
            return target != null ? target.ToString() : "-> <empty divert>";
        }
