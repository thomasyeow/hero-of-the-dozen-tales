...
namespace Ink.Parsed
{
    public class ListDefinition : Parsed.Object
    {
        ...
        public ListElementDefinition ItemNamed(string itemName)
        {
            ...
            return _elementsByName.TryGetValue(itemName, out foundElement) ? foundElement : null;
        }
        ...
        public override Runtime.Object GenerateRuntimeObject()
        {
            ...
            foreach (var itemDef in itemDefinitions)
            {
                ...
                {
                    var item = new Runtime.InkListItem(identifier?.name, itemDef.name);
