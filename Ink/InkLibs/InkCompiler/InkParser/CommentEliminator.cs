...
namespace Ink
{
    ...
    public class CommentEliminator : StringParser
    {
        ...
        public string Process()
        {
            ...
            return stringList != null ? string.Join("", stringList.ToArray()) : null;
        }
        ...
        string CommentsAndNewlines()
        {
            ...
            return newlines != null ? string.Join("", newlines.ToArray()) : null;
        }
        ...
        string BlockComment()
        {
            ...
            return commentResult != null ? new string('\n', lineIndex - startLineIndex) : null;
        }
