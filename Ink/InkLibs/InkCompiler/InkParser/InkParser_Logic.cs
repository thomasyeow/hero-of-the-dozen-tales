...
namespace Ink
{
    public partial class InkParser
    {
        ...
        protected Parsed.ListDefinition ListDefinition()
        {
            ...
            return allElements == null ? null : new ListDefinition(allElements);
        }
        ...
        protected Parsed.Glue Glue()
        {
            ...
            return glueStr != null ? new Parsed.Glue(new Runtime.Glue()) : null;
        }
        ...
        protected Parsed.Object InnerLogic()
        {
            ...
            if (explicitSeqType != null)
            {
                ...
                return contentLists == null ? null : (Object)new Sequence(contentLists, (SequenceType)explicitSeqType);
            }
        ...
        protected string Identifier()
        {
            ...
            return isNumberCharsOnly ? null : name;
        }
