...
namespace Ink
{
    public partial class InkParser
    {
        protected Sequence InnerSequence()
        {
            ...
            return contentLists == null || contentLists.Count <= 1 ? null : new Sequence(contentLists, seqType);
        }
        ...
        protected object SequenceTypeSymbolAnnotation()
        {
            ...
            return sequenceType == 0 ? null : sequenceType;
        }
        ...
        protected object SequenceTypeSingleWord()
        {
            ...
            return seqType == null ? null : (object)seqType;
        }
        ...
        protected List<ContentList> InnerSequenceObjects()
        {
            ...
            List<ContentList> result = multiline ? Parse(InnerMultilineSequenceObjects) : Parse(InnerInlineSequenceObjects);
            return result;
        }
        ...
        protected List<ContentList> InnerMultilineSequenceObjects()
        {
            ...
            return contentLists == null ? null : contentLists.Cast<ContentList>().ToList();
        }
