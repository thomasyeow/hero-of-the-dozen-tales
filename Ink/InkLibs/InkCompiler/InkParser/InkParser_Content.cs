...
namespace Ink
{
    public partial class InkParser
    {
        ...
        protected Parsed.Text ContentTextAllowingEcapeChar()
        {
            ...
            return sb != null ? new Parsed.Text(sb.ToString()) : null;
        }
        ...
        protected string ContentTextNoEscape()
        {
            ...
            CharacterSet endChars = parsingStringExpression ? _notTextEndCharactersString : _parsingChoice ? _notTextEndCharactersChoice : _nonTextEndCharacters;
            string pureTextContent = ParseUntil(nonTextRule, _nonTextPauseCharacters, endChars);
            return pureTextContent != null ? pureTextContent : null;
