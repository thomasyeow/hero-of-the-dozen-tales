...
namespace Ink
{
    public partial class InkParser
    {
        ...
        protected Parsed.Object TempDeclarationOrAssignment()
        {
            ...
            Identifier varIdentifier = isNewDeclaration ? (Identifier)Expect(IdentifierWithMetadata, "variable name") : Parse(IdentifierWithMetadata);
        ...
        protected Number ExpressionInt()
        {
            ...
            return intOrNull == null ? null : new Number(intOrNull.Value);
        }

        protected Number ExpressionFloat()
        {
            float? floatOrNull = ParseFloat();
            return floatOrNull == null ? null : new Number(floatOrNull.Value);
        }
        ...
        protected Expression ExpressionFunctionCall()
        {
            ...
            return arguments == null ? null : (Expression)new FunctionCall(iden, arguments);
        }
        ...
        protected Expression ExpressionVariableName()
        {
            ...
            return path == null || Story.IsReservedKeyword(path[0].name) ? null : (Expression)new VariableReference(path);
        }
        ...
        protected Parsed.List ExpressionList()
        {
            ...
            return ParseString(")") == null ? null : new List(memberNames);
        }
