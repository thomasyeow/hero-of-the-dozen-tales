...
namespace Ink
{
    public partial class InkParser
    {
        ...
        protected Expression ChoiceCondition()
        {
            ...
            return conditions == null ? null : conditions.Count == 1 ? conditions[0] : new MultipleConditionExpression(conditions);
        }
        ...
        protected object GatherDashes()
        {
            ...
            return gatherDashCount == 0 ? null : gatherDashCount;
        }
        ...
        protected object ParseDashNotArrow()
        {
            ...
            return ParseString("->") == null && ParseSingleCharacter() == '-' ? SucceedRule(ruleId) : FailRule(ruleId);
        }
