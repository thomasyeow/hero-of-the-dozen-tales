...
namespace Ink.Runtime
{
    public class NativeFunctionCall : Runtime.Object
    {
        ...
        public int numberOfParameters
        {
            get
            {
                return _prototype ? _prototype.numberOfParameters : _numberOfParameters;
            }
            protected set
            {
        ...
        Value CallBinaryListOperation(List<Runtime.Object> parameters)
        {
            ...
            return v1.valueType == ValueType.List && v2.valueType == ValueType.List
                ? Call<InkList>(new List<Value> { v1, v2 })
