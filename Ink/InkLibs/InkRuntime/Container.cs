    ...
    public class Container : Runtime.Object, INamedContent
    {
        ...
        protected Runtime.Object ContentWithPathComponent(Path.Component component)
        {
            if (component.isIndex)
            {
                ...
                return component.index >= 0 && component.index < content.Count ? content[component.index] : null;
            ...
            else
            {
                ...
                return namedContent.TryGetValue(component.name, out foundContent) ? (Runtime.Object)foundContent : null;
            }
        }
