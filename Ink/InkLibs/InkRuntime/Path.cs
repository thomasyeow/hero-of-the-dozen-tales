...
namespace Ink.Runtime
{
    public class Path : IEquatable<Path>
    {
        ...
        public class Component : IEquatable<Component>
        {
            ...
            {
                return isIndex ? index.ToString() : name;
            }
            ...
            {
                return otherComp != null && otherComp.isIndex == isIndex ? isIndex ? index == otherComp.index : name == otherComp.name : false;
            }

            public override int GetHashCode()
            {
                return isIndex ? index : name.GetHashCode();
            }
        }
        ...
        public Component head
        {
            get
            {
                return _components.Count > 0 ? _components.First() : null;
            }
        }
        ...
        public Component lastComponent
        {
            get
            {
                ...
                return lastComponentIdx >= 0 ? _components[lastComponentIdx] : null;
            }
        }
        ...
        public bool Equals(Path otherPath)
        {
            return otherPath == null
                ? false
                : otherPath._components.Count != _components.Count
                ? false
                : otherPath.isRelative != isRelative ? false : otherPath._components.SequenceEqual(_components);
        }
