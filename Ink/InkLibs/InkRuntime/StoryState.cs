...
namespace Ink.Runtime
{
    ...
    public class StoryState
    {
        ...
        public int VisitCountAtPathString(string pathString)
        {
            ...
            return _visitCounts.TryGetValue(pathString, out visitCountOut) ? visitCountOut : 0;
        }
        ...
        public int TurnsSinceForContainer(Container container)
        {
            ...
            var containerPathStr = container.path.ToString();
            return _turnIndices.TryGetValue(containerPathStr, out index) ? currentTurnIndex - index : -1;
        }
        ...
        public List<Choice> currentChoices
        {
            get
            {
                ...
                return canContinue ? new List<Choice>() : _currentFlow.currentChoices;
            }
        }
        ...
        public string currentPathString
        {
            get
            {
                ...
                return pointer.isNull ? null : pointer.path.ToString();
            }
        }
        ...
        void LoadJsonObj(Dictionary<string, object> jObject)
        {
            ...
            previousRandom = jObject.TryGetValue("previousRandom", out previousRandomObj) ? (int)previousRandomObj : 0;
        }
        ...
        void PushToOutputStreamIndividual(Runtime.Object obj)
        {
            ...
            else if (text)
            {
                ...
                var trimIndex = -1;
                trimIndex = glueTrimIndex != -1 && functionTrimIndex != -1
