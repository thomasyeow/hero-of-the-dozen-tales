...
namespace Ink.Runtime
{
    public class Divert : Runtime.Object
    {
        ...
        public string targetPathString
        {
            get
            {
                return targetPath == null ? null : CompactPathString(targetPath);
            }
            set
            {
                targetPath = value == null ? null : new Path(value);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (otherDivert)
            {
                ...
                {
                    return hasVariableTarget ? variableDivertName == otherDivert.variableDivertName : targetPath.Equals(otherDivert.targetPath);
                }
            }
            return false;
        }
