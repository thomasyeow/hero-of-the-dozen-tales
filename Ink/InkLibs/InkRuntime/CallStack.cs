...
namespace Ink.Runtime
{
    public class CallStack
    {
        ...
        public bool CanPop(PushPopType? type = null)
        {
            ...
            return !canPop ? false : type == null ? true : currentElement.type == type;
        }
        ...
        public Runtime.Object GetTemporaryVariableWithName(string name, int contextIndex = -1)
        {
            ...
            return contextElement.temporaryVariables.TryGetValue(name, out varValue) ? varValue : null;
        }
        ...
        public int ContextForVariableNamed(string name)
        {
            ...
            return currentElement.temporaryVariables.ContainsKey(name) ? currentElementIndex + 1 : 0;
        }
