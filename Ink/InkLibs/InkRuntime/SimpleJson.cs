    ...
    public static class SimpleJson
    {
        ...
        class Reader
        {
            ...
            void Expect(bool condition, string message = null)
            {
                if (!condition)
                {
                    message = message == null ? "Unexpected token" : "Expected " + message;
        ...
        public class Writer
        {
            ...
            State state
            {
                get
                {
                    return _stateStack.Count > 0 ? _stateStack.Peek().type : State.None;
                }
            }
            ...
            int childCount
            {
                get
                {
                    return _stateStack.Count > 0 ? _stateStack.Peek().childCount : 0;
                }
            }
