...
namespace Ink.Runtime
{
	...
	public class Story : Runtime.Object
    {
        ...
        public Runtime.Container KnotContainerWithName(string name)
        {
            ...
            return mainContentContainer.namedContent.TryGetValue(name, out namedContainer) ? namedContainer as Container : null;
        }
            ...
            else if (contentObj is ControlCommand)
            {
                ...
                switch (evalCommand.commandType)
                {
                    ...
                    case ControlCommand.CommandType.ReadCount:
                        ...
                        if (container != null)
                        {
                            eitherCount = evalCommand.commandType == ControlCommand.CommandType.TurnsSince
                                ? state.TurnsSinceForContainer(container)
                                : state.VisitCountForContainer(container);
                        }
                        else
                        {
        ...
        public Runtime.Object EvaluateExpression(Runtime.Container exprContainer)
        {
            ...
            return endStackHeight > evalStackHeight ? state.PopEvaluationStack() : null;
        ...
        void AddError(string message, bool isWarning = false, bool useEndLineNumber = false)
        {
            ...
            {
                message = !state.currentPointer.isNull
                    ? string.Format("RUNTIME {0}: ({1}): {2}", errorTypeStr, state.currentPointer.path, message)
        ...
        int currentLineNumber
        {
            ...
            {
                var dm = currentDebugMetadata;
                return dm != null ? dm.startLineNumber : 0;
            }
        }
        ...
        public Container mainContentContainer
        {
            get
            {
                return _temporaryEvaluationContainer ? _temporaryEvaluationContainer : _mainContentContainer;
            }
        }
