	...
	public class VariablesState : IEnumerable<string>
    {
        ...
        public object this[string variableName]
        {
            get
            {
                ...
                return _globalVariables.TryGetValue(variableName, out varContents) ||
                     _defaultGlobalVariables.TryGetValue(variableName, out varContents)
                    ? (varContents as Runtime.Value).valueObject
                    : null;
            }
            set
            {
        ...
        public void SetJsonToken(Dictionary<string, object> jToken)
        {
            ...
            {
                object loadedToken;
                _globalVariables[varVal.Key] = jToken.TryGetValue(varVal.Key, out loadedToken) ? Json.JTokenToRuntimeObject(loadedToken) : varVal.Value;
            }
        }
        ...
        public bool RuntimeObjectsEqual(Runtime.Object obj1, Runtime.Object obj2)
        {
            ...
            return val1 != null
                ? val1.valueObject.Equals(val2.valueObject)
        ...
        public void Assign(VariableAssignment varAss, Runtime.Object value)
        {
            ...
            bool setGlobal = varAss.isNewDeclaration ? varAss.isGlobal : GlobalVariableExistsWithName(name);
        ...
        VariablePointerValue ResolveVariablePointer(VariablePointerValue varPointer)
        {
            ...
            return doubleRedirectionPointer ? doubleRedirectionPointer : new VariablePointerValue(varPointer.variableName, contextIndex);
        }
        ...
        {
            return GlobalVariableExistsWithName(varName) ? 0 : _callStack.currentElementIndex;
        }
