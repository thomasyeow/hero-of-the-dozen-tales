    ...
    public static class Json
    {
        ...
        public static void WriteRuntimeObject(SimpleJson.Writer writer, Runtime.Object obj)
        {
            ...
            if (divert)
            {
                ...
                string targetStr = divert.hasVariableTarget ? divert.variableDivertName : divert.targetPathString;
                writer.WriteObjectStart();
        ...
        public static Runtime.Object JTokenToRuntimeObject(object token)
        {
            ...
            return token is List<object>
                ? JArrayToContainer((List<object>)token)
                : (Object)(token == null ? null : throw new System.Exception("Failed to convert token to runtime object: " + token));
        }
