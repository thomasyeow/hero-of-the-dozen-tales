...
namespace Ink.UnityIntegration
{
    ...
    public class InkFile
    {
        ...
        public string filePath
        {
            get
            {
                return inkAsset == null ? null : InkEditorUtils.SanitizePathString(AssetDatabase.GetAssetPath(inkAsset));
            }
        }
        ...
        public string absoluteFilePath
        {
            get
            {
                return inkAsset == null ? null : InkEditorUtils.UnityRelativeToAbsolutePath(filePath);
            }
        }
        ...
        public string absoluteJSONPath
        {
            get
            {
                return inkAsset == null ? null : InkEditorUtils.UnityRelativeToAbsolutePath(jsonPath);
            }
        }
        ...
        public bool requiresCompile
        {
            get
            {
                return !isMaster ? false : jsonAsset == null || lastEditDate > lastCompileDate || hasUnhandledCompileErrors;
            }
        }
