...
namespace Ink.UnityIntegration
{
    ...
    public static class InkEditorUtils
    {
        ...
        public static bool disallowedAutoRefresh
        {
            get
            {
                return EditorPrefs.HasKey("InkLibraryDisallowedAutoRefresh") ? EditorPrefs.GetBool("InkLibraryDisallowedAutoRefresh") : false;
            }
            set
            {
        ...
        public static bool IsInkFile(string path)
        {
            ...
            return extension == InkEditorUtils.inkFileExtension
                ? true
                : String.IsNullOrEmpty(extension) && InkLibrary.instance.inkLibrary.Exists(f => f.filePath == path);
        }
    }
}